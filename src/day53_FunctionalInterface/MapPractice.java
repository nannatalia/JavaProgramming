...
public class MapPractice {
    public static void main(String[] args) {
        ...
        for (Map<String, Double> unit : allUnits) {
        ...
        System.out.println("Java Topics we spent more than 7 hours:");
        for (Map<String, Double> unit : allUnits) {
            for (Map.Entry<String, Double> entry : unit.entrySet()) {
                if(entry.getValue()>7){
                    System.out.println(entry.getKey() + " : " + entry.getValue());
        ...
        System.out.println("Java Topics we spent less than 3 hours:");
        for (Map<String, Double> unit : allUnits) {
            for (Map.Entry<String, Double> entry : unit.entrySet()) {
                if (entry.getValue() < 3) {
                    System.out.println(entry.getKey() + " : " + entry.getValue());
        ...
        System.out.println("The Java Topic that has the maximum hours: ");
        ...
        System.out.println("The Java Topic that has the minimum hours:");
